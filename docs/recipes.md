...
This file contains high-signal prompt patterns for using Agent Evidence MCP well.

## Long Browser Task

```text
Complete this browser-based task from start to finish.
Use the agent-evidence MCP server.
...
```text
Use the agent-evidence MCP server while investigating this UI bug.
...
```text
Use the agent-evidence MCP server for this flow.
...
```text
Use the agent-evidence MCP server for this review flow.
...
```text
Use the agent-evidence MCP server for this long task review.
...
```text
Use the agent-evidence MCP server for this task and leave a clean review trail.
